...
class DropboxCloud {
    ...
    static #SDK = null;
    /** @type {Promise<Object>} */
    static #sdkPromise = import('https://cdn.skypack.dev/dropbox').then( (pkg) => pkg.Dropbox );
    ...
    constructor(clientId, redirectUri = '', appId = null, tokenStorage = null) {
        ...
        this.#dbx = new DropboxCloud.#SDK({ clientId: clientId });
    ...
    async OAuth(timeout = null) {
        if (await this.#OAuthRefreshToken()) { return; }
